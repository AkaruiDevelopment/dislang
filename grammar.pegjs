...
Program
    = __ elements:SourceElement+ __ { return {kind: "program", body: [...elements]} }

SourceElement
    = VariableDeclaration

VariableDeclaration
    = "var" __ name:Identifier __ "=" __ init:Literal { return {kind: "variableDeclaration", id: name, initializer: init} }
...
StringLiteral "string"
  = '"' chars:DoubleStringCharacter* '"' {
      return { kind: "literal", value: chars.join("") };
    }
...
NonEscapeCharacter = !(EscapeCharacter / LineTerminator) . { return text(); }
...
NumberLiteral
    = int:Int { return {kind: "literal", raw: int} }
    / float:Float { return {kind: "literal", raw: float} }

Int = [0-9]+
Float = [0-9]* "." Int

__ = (Comment / WhiteSpace / LineTerminator)*
